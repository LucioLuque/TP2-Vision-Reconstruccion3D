...
from utils import write_pickle, print_rect_info
...
def complete_rectification(calib_info, print_info=False):
    """
...
def write_complete_rect_pickle(calib_info, rect_pickle_path, print_info=False):
    """
    Write the complete rectification results to a pickle file.
    """
    rectification_results = complete_rectification(calib_info, print_info=print_info)
